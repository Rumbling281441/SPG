...
class ADPipeline(StableDiffusionXLPipeline):
    ...
    def sample(
        ...
        **kwargs,
        ...
        if self.do_classifier_free_guidance and self.do_pag:
        ...
        if ip_adapter_image is not None or ip_adapter_image_embeds is not None:
            ...
            added_cond_kwargs_style['image_embeds']=image_embeds
        ...
        for i, t in enumerate(pbar):
            with torch.no_grad():
                ...
                elif self.do_classifier_free_guidance and self.do_pag:
